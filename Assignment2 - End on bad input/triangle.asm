...
; If input is invalid
invalid: db "A number below or equal to zero was detected, the program will now end.", 0
...
triangle:
    ...
    ; move 0 into xmm0, in the case that there's an error
    movsd xmm0, xmm11
    
    jmp end ; jump to end block, where we will be restoring registers
