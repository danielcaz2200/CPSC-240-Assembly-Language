...
; exit message
exit_msg: db "Daniel wishes you a nice day. Nanoseconds will be returned to the driver.", 10, 0
...
execution_time: db "The execution time was %lu tics which equals %0.2lf nanoseconds based on processor GHz.", 10, 0
...
manager:
	...
	; jump if xmm15 below or equal xmm11
	jbe bad_input
