...
nasm -f elf64 -o hertz_bss.o hertz_bss.asm

nasm -f elf64 -o validate.o validate.asm
...
gcc -m64 -std=c11 -no-pie -o power.out maxwell.o hertz_bss.o validate.o isfloat.o
