...
nasm -f elf64 -o hertz.o hertz.asm -g -gdwarf

echo "Compile the C files."
gcc -c -m64 -Wall -std=c11 -no-pie -o maxwell.o maxwell.c -g

gcc -c -m64 -Wall -std=c11 -no-pie -o isfloat.o isfloat.c -g

echo "Link the 'O' files."
gcc -m64 -std=c11 -no-pie -o power.out maxwell.o hertz.o isfloat.o -g
